...
class FlashWindow(wx.activex.ActiveXWindow):
    def __init__(self, parent, ID=-1, pos=wx.DefaultPosition,
                 size=wx.DefaultSize, style=0, name='FlashWin'):
    ...
    def _get_AllowNetworking(self):
        return self.GetAXProp('AllowNetworking')
    def _set_AllowNetworking(self, AllowNetworking):
        self.SetAXProp('AllowNetworking', AllowNetworking)
    allownetworking = property(_get_AllowNetworking, _set_AllowNetworking)

    def _get_AllowFullScreen(self):
        return self.GetAXProp('AllowFullScreen')
    def _set_AllowFullScreen(self, AllowFullScreen):
        self.SetAXProp('AllowFullScreen', AllowFullScreen)
    allowfullscreen = property(_get_AllowFullScreen, _set_AllowFullScreen)
